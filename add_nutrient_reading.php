...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $sql = "INSERT INTO soil_nutrients 
                   (field_id, test_date, nitrogen, phosphorus, potassium, ph_level, 
                    organic_matter, calcium, magnesium, sulfur, test_method, notes) 
                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            header("Location: soil_nutrients.php?success=1");
            exit();
            
        } catch(PDOException $e) {
            error_log("Error saving soil nutrient data: " . $e->getMessage());
...
$pageTitle = 'Add Nutrient Reading';
include 'includes/header.php';
?>

<div class="main-content">
    <div class="page-header">
        <h2><i class="fas fa-flask"></i> Add Soil Nutrient Reading</h2>
    ...
    <div class="card">
        <div class="card-header">
            <i class="fas fa-edit me-2"></i>Soil Nutrient Test Details
        </div>
        <div class="card-body">
            <form method="post" action="">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="field_id" name="field_id" required>
                            ...
                            <option value="<?php echo $field['id']; ?>" <?php echo (isset($_POST['field_id']) && $_POST['field_id'] == $field['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="test_date" name="test_date" 
                               value="<?php echo isset($_POST['test_date']) ? htmlspecialchars($_POST['test_date']) : date('Y-m-d'); ?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="nitrogen" name="nitrogen" 
                               value="<?php echo isset($_POST['nitrogen']) ? htmlspecialchars($_POST['nitrogen']) : ''; ?>" required>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="phosphorus" name="phosphorus" 
                               value="<?php echo isset($_POST['phosphorus']) ? htmlspecialchars($_POST['phosphorus']) : ''; ?>" required>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="potassium" name="potassium" 
                               value="<?php echo isset($_POST['potassium']) ? htmlspecialchars($_POST['potassium']) : ''; ?>" required>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.1" min="0" max="14" class="form-control" id="ph_level" name="ph_level" 
                               value="<?php echo isset($_POST['ph_level']) ? htmlspecialchars($_POST['ph_level']) : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" max="100" class="form-control" id="organic_matter" name="organic_matter" 
                               value="<?php echo isset($_POST['organic_matter']) ? htmlspecialchars($_POST['organic_matter']) : ''; ?>">
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="calcium" name="calcium" 
                               value="<?php echo isset($_POST['calcium']) ? htmlspecialchars($_POST['calcium']) : ''; ?>">
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="magnesium" name="magnesium" 
                               value="<?php echo isset($_POST['magnesium']) ? htmlspecialchars($_POST['magnesium']) : ''; ?>">
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="sulfur" name="sulfur" 
                               value="<?php echo isset($_POST['sulfur']) ? htmlspecialchars($_POST['sulfur']) : ''; ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="test_method" name="test_method" required>
                            ...
                            <option value="<?php echo $method; ?>" <?php echo (isset($_POST['test_method']) && $_POST['test_method'] == $method) ? 'selected' : ''; ?>>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button type="submit" class="btn btn-primary">Save Nutrient Reading</button>
                </div>
            </form>
        </div>
    ...
    <div class="card mt-4">
        <div class="card-header">
            <i class="fas fa-info-circle me-2"></i>Nutrient Level Guidelines
        </div>
        <div class="card-body">
                ...
                <table class="table table-sm table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-warning">Medium</th>
                            <th class="text-success">Optimal</th>
            ...
            <div class="alert alert-info mt-3 mb-0">
                <p class="mb-0"><strong>Note:</strong> These are general guidelines. Optimal levels may vary depending on crop type, soil type, and local conditions.</p>
            </div>
        </div>
    </div>
</div>
