...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (empty($date) || empty($type) || empty($next_due) || empty($administered_by)) {
            throw new Exception("All fields are required");
        }

        // Validate next_due date is after vaccination date
        if (strtotime($next_due) <= strtotime($date)) {
            throw new Exception("Next due date must be after vaccination date");
        }

        // Insert the new vaccination record
        $stmt = $pdo->prepare(
            "INSERT INTO vaccinations (animal_id, date, type, next_due, administered_by) 
...
<head>
    ...
    <title>Add Vaccination Record - <?php echo htmlspecialchars($animal_id); ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2>Add Vaccination Record - <?php echo htmlspecialchars($animal_id); ?></h2>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="type" name="type" class="form-control" required
                           placeholder="Enter vaccine type (e.g., Foot-and-mouth disease)">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="administered_by" name="administered_by" class="form-control" required
    ...
    <script>
    // Set minimum date for next_due date based on vaccination date
    document.getElementById('date').addEventListener('change', function() {
        document.getElementById('next_due').min = this.value;
    });
    </script>
</body>
</html>