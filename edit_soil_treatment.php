...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            header("Location: soil_treatments.php?updated=1");
            exit();
            
        } catch(PDOException $e) {
            error_log("Error updating soil treatment: " . $e->getMessage());
...
$pageTitle = 'Edit Soil Treatment';
include 'includes/header.php';
?>

<div class="main-content">
    <div class="page-header">
        <h2><i class="fas fa-flask"></i> Edit Soil Treatment</h2>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="edit_soil_treatment.php?id=<?php echo $treatment_id; ?>">
                <div class="row mb-3">
                    <div class="col-md-6">
